    ...
    return (
        <div className='flex flex-col items-center'>
            ...
            <div className='w-full flex items-center gap-3 justify-center mt-5'>
                <input
                    className='w-3/5 px-3 py-4 rounded-lg bg-gray-900 text-teal-100 font-bold'
            ...
            <TableContainer className='mt-10  no-scrollbar scroll-smooth'>
                {loading === true ? (
                    ...
                    <Table>
                        ...
                        <TableHead style={{ backgroundColor: '#2DD4BF' }}>
                            ...
                            {handleSearch()
                                ...
                                .map((row) => {
                                    return (
                                        ...
                                        bg-gray-900 hover:bg-gray-950 active:bg-black duration-300 my-3 mx-2 rounded-lg min-w-max'
                                            >
                                                <div className='flex flex-col items-center gap-1 w-1/5'>
                                                    ...
                                                    />
                                                    <p className='text-teal-400 font-extrabold uppercase'>{row?.symbol}</p>
                                                </div>

                                                <h1 className='text-white  font-bold w-1/5 hidden lg:inline-flex xl:inline-flex text-xl'>
                                                    {row?.name}
                                                </h1>
                                                <h1 className='text-teal-500 w-1/5 flex gap-1 text-xl font-semibold font-mono'>
